            ...
            <InputGroup compact>
              ...
              {getFieldDecorator('mobile', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'useranduserregister.phone-number.required',
                    }),
                  },
                  {
                    pattern: /^\d{11}$/,
                    message: formatMessage({
                      id: 'useranduserregister.phone-number.wrong-format',
                    }),
                  },
                ],
              })(
                <Input
                  ...
                  placeholder={formatMessage({
                    id: 'useranduserregister.phone-number.placeholder',
                  })}
                />,
              )}
            </InputGroup>
                  ...
                  rules: [
                    {
                      required: true,
                      message: formatMessage({
                        id: 'useranduserregister.verification-code.required',
                      }),
                    },
                  ],
                })(
              ...
              <Col span={8}>
                ...
                >
                  {count
                    ? `${count} s`
                    : formatMessage({
                        id: 'useranduserregister.register.get-verification-code',
                      })}
                </Button>
              </Col>
            </Row>
